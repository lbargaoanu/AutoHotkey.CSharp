...
namespace WindowsInput
{
    ...
    public static class InputSimulator
    {
        ...
        public static void SimulateKeyDown(Keys keyCode)
        {
            ...
            down.Data.Keyboard.Scan = 0x39;
            down.Data.Keyboard.Flags = (UInt32) KeyboardFlag.SCANCODE;
        ...
        public static void SimulateKeyUp(Keys keyCode)
        {
            ...
            up.Data.Keyboard.Scan = 0x39;
            up.Data.Keyboard.Flags = (UInt32)(KeyboardFlag.KEYUP | KeyboardFlag.SCANCODE);
        ...
        public static void SimulateModifiedKeyStroke(Keys modifierKeyCode, Keys keyCode)
        {
        ...
        /// <param name="keyCode">The key to simulate</param>
        public static void SimulateModifiedKeyStroke(IEnumerable<Keys> modifierKeyCodes, Keys keyCode)
        {
        ...
        public static void SimulateModifiedKeyStroke(Keys modifierKey, IEnumerable<Keys> keyCodes)
        {
        ...
        /// <param name="modifierKeyCodes">The list of modifier keys</param>
        /// <param name="keyCodes">The list of keys to simulate</param>
        public static void SimulateModifiedKeyStroke(IEnumerable<Keys> modifierKeyCodes, IEnumerable<Keys> keyCodes)
        {
            if (modifierKeyCodes != null) modifierKeyCodes.ToList().ForEach(x => SimulateKeyDown(x));
            if (keyCodes != null) keyCodes.ToList().ForEach(x => SimulateKeyPress(x));
            if (modifierKeyCodes != null) modifierKeyCodes.Reverse().ToList().ForEach(x => SimulateKeyUp(x));
